   ...
   <body>
      ...
      <div class="invoice-box">
         <table>
            ...
            <?php $subservice=$this->InvoiceModel->getsubservice($data1[0]['ssid']); ?>
            <tr class="heading">
               <td>Service</td>
               <?php if(!empty($subservice)){ ?>
               <td>Sub Services</td>
               <?php  } ?>
               <?php $i=0; foreach($data1 as $datas){
                  $productname=$this->db->select('product_name')->from('inventory')->where('inventory_id',$datas['product_id'])->get()->row();
            ...
            <tr class="item">
               <td><?php echo $data1[0]['service_name'];?></td>
               <?php if(!empty($subservice)){ ?>
               <?php foreach($subservice as $subservices){ ?>
               <td><?php echo $subservices->sub_service_name ;?></td>
               <?php  } }  ?>
               <?php $i=0; foreach($data1 as $datas){
                  $productname=$this->db->select('product_name')->from('inventory')->where('inventory_id',$datas['product_id'])->get()->row();
                  ...
                  if(!empty($productname)){ 
                  ?>
               <td style=" text-align: left;"><?=$productname?$productname->product_name:'';?></td>
            ...
            <tr class="total">
               ...
               <?php // var f_dis= (dis_amt / parseInt(Amt)) * 100;
                  ...
                  ?>                  
               <td>Amount: $<?php echo $data[0]['bamount'];?></td>
            </tr>
            <tr class="total">
               <td></td>
               <td>Discount : $<?php echo $dis;?></td>
            </tr>
            <tr class="total">
               <td></td>
               <td>Total: $<?php echo $netamount = $data[0]['tamount'] ;?></td>
            </tr>
         </table>
      </div>
