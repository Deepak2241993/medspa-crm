...
<br>    
        ...
        <div class="form-group row">
            ...
            <input type="button" class="btn btn-primary" value="Show Service Usage" id="showusage">
            </div>
        </div>
...
<div class="col-sm-6">
<div class="checkbox">
<input id="checkbox65" type="checkbox" class="contoura" name="contoura" checked>
...
<!-------------------- Tattoo Services Start ------------------------------>
    ...
    <div class="form-group row">
    <label for="inputEmail3" class="col-sm-2 col-form-label"><b>Additional comments</b></label>
    <div class="col-sm-3">
    <textarea rows="3" cols="70" name="comments"  placeholder="Enter text here...">
    </textarea>
    </div>
    </div>
    <br>
