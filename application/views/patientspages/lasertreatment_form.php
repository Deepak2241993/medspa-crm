...
<div class="col-sm-6">
<div class="checkbox">
<input id="checkbox55" type="checkbox" class="laser-treatment" name="laser-treatment" checked="">
...
<a href="#">Add One More Row</a>
 ...
 <!------------------- Neurotoxin Service Start ------------------------->
     ...
     <hr style="background-color:grey;height: 1px;">       
        <div class="form-group row">
        <label style="font-size: 16px;font-weight: 2px;" class="col-sm-3 col-form-label"><b>Service Name</b></label>
        <label style="border: none;font-size: 16px;color:navy;" class="col-sm-3 form-control">Neurotoxin</label>
    ...
    <div class="col-sm-6">
    <div class="checkbox">
    <input id="checkbox13" type="checkbox" name="nurotoxis" checked="">
