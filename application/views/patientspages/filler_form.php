...
<br>    
        ...
        <input type="hidden" name="pid" id="pid" value="<?=$pdata[0]['prid']?>">
        <input type="hidden" name="pcid" id="pcid" value="<?=$pdata[0]['prid']?>">
    ...
    <div class="form-group row">
    <label style="font-size: 16px;font-weight: 2px" class="col-sm-3 col-form-label">
        <b>Service Name</b></label>
        <label style="border: none;font-size: 16px;color:navy" class="col-sm-3 form-control">Filler</label>
    </div>
...
<div class="col-sm-6">
<div class="checkbox">
<input id="checkbox14" type="checkbox" name="filler" checked="">
...
<div id="rfal" style="display:none;">
<div class="form-group row">
<label style="font-size: 16px;font-weight: 2px;" class="col-sm-3 col-form-label"><b>Patient Name</b></label>
...
<div class="col-sm-6">
<div class="checkbox">
<input id="checkbox16" type="checkbox" class="rfal" name="rfal">
...
<div class="col-sm-6">
<div class="checkbox">
<input id="checkbox54" type="checkbox" class="rfmn" name="rfmn">
...
<div class="col-sm-6">
      <div class="checkbox">
      <input id="checkbox86" type="checkbox" class="vi-peel" name="vi_peel">
...
<div id="Tattoo" style="display:none;">
    ...
    <div class="form-group row">
    <label style="font-size: 16px;font-weight: 2px;" class="col-sm-3 col-form-label"><b>Service Name</b></label>
    <label style="border: none;font-size: 16px;color:navy;" class="col-sm-3 form-control">Tattoo</label>
    </div>
    <hr style="background-color:grey;height: 1px;">
    <div class="fillerform">
    <div class="col-sm-6">
...
$('#sub_srv_fun').change(function(){
  // debugger
   ...
   $.ajax({
     url:"<?=base_url('get_inventory_data_by_service_and_product');?>",//baseURL+'index.php/user/userDetails',
     method: 'get',
