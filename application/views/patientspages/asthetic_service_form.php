...
<br>    
        ...
        <label style="border: none;font-size: 16px;color:navy;" class="col-sm-3 form-control">Asthetic</label>
        <!-- <label style="font-size: 16px;font-weight: 2px;" class="col-sm-3 col-form-label"><b>Device Name</b></label> -->
        <!-- <select class="col-sm-3 form-control" id="Asthetic-Services"> -->
<!--              <?php
...
<!--------------------- asthetic_services Service Start ----------------------------------->

<div id="Asthetic-Services" >
<div class="form-group row">
<label style="font-size: 16px;font-weight: 2px;" class="col-sm-3 col-form-label"><b>Service Name</b></label>
...
<div class="col-sm-6">
      <div class="checkbox">
      <input id="checkbox69" type="checkbox" class="asthetic_services" name="Asthetic-Services" checked>
...
<div class="container">
    ...
    <textarea name="any_area" class="col-sm-4 form-control" placeholder="Any area"></textarea>
    </div>
