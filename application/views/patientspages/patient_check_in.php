...
<div class="main-content">
   <div class="card">
      <div class="card-body">
         ...
         <div class="m-t-25">
            <?=form_open('patients/save_patients_checkin')?>
            <!--  <h5> </h5>  -->
            <div class="form-group row">
               <label for="inputEmail3" class="col-sm-2 col-form-label" >Name of the Patient</label>
               <div class="col-sm-6">
                  <input type="hidden" id="patient_app_id" name="patient_app_id" value="<?php echo $this->uri->segment(3);?>" readonly>
                  <input type="hidden" id="patient_app_time" name="patient_app_time" value="<?php echo $appointment_Data[0]->app_time;?>" readonly>
                  <input type="hidden" id="patient_app_date" name="patient_app_date" value="<?php echo $appointment_Data[0]->app_date;?>" readonly>
                  <input type="hidden" id="service_category_id" name="service_category_id" value="<?php echo $appointment_Data[0]->service_category_id;?>" readonly>
                  <select name="pname" class="form-control"  id="pname" >
                     ...
                     <option value="<?= $patients->prid?>" <?php ($patients->prid ==  $appointment_Data[0]->patient_id) ? 'selected' : '';?>><?= $patients->pname?></option>
            ...
            <div class="form-group row">
               ...
               <div class="col-sm-3">
                  ...
                  <input type="number" class="form-control" id="room_no" name="room_no" value="<?php if(isset($patients_note_data[0]['room_no'])) echo $patients_note_data[0]['room_no'];?>" placeholder="Room No" required>
               </div>
