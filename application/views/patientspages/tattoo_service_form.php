...
<!-------------------- Tattoo Services Start ------------------------------>
    ...
    <input id="checkbox105" type="checkbox" class="tattoo_service" name="tattoo_service" checked="">
...
<label for="checkbox16">Check this for select 11</label>
</div>
</div>
