                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="m-l-15">
                                            <h2 class="m-b-0">Patient Dashboard</h2>
                                            <!--<p class="m-b-0 text-muted">Patient Dashboard</p>-->
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="m-l-15">
                                            <button onclick="window.location.href='<?=base_url()?>patients/patient_note_list/'">Invoicing List</button>
                                            <!--<h2 class="m-b-0">Invoicing</h2>-->
                                            
                                            <!--<p class="m-b-0 text-muted">Invoicing</p>-->
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="m-l-15">
                                            <button onclick="window.location.href='<?=base_url()?>patients/patient_note_list/'">Patient List</button>
                                            <!--<h2 class="m-b-0" href="<?=base_url()?>patients/patient_note_list/">Patient List</h2>-->
