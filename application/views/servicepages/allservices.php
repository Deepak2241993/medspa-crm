...
<table id="data-table" class="table table-bordered">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><a data-toggle="modal" data-target="#serviceUpdate_<?= $service->sid ?>"  class="btn btn-primary btn-xs">Edit</a>
             <a href="javascript:void(0);" onclick="deletedat('<?php echo $service->sid ;?>');" class="btn btn-danger btn-xs">Delete</a> </td> 


             <!-- Model Code For Update -->
            <div class="modal fade" id="serviceUpdate_<?= $service->sid ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-success" role="document">
                    <div class="modal-content">
                        ...
                        <div class="card-body">
                            <form action="<?= base_url()?>services/updateServiceData/<?=$service->sid?>" method="post"  enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"  value="<?=$service->service_charge?>" name="service_charge" class="form-control" placeholder="if any charge by service base">
                                </div> 
                                <div class="form-group">
                                ...
                                <input type="hidden" name="sid" id="id" value="<?=$service->sid?>">
...
<script type="text/javascript">		
   ...
   $(document).on('submit', '#type_of_listing_frm', function(event) {
    ...
    function deletedat(sid){
       var url="<?php echo base_url();?>";
       var r=confirm("Do you want to delete this?");
        if (r==true)
          window.location = url+"services/deleteservices/"+sid;
