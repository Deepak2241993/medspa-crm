...
var myLineChart = new Chart(ctxL, {
  type: 'bar',
  data: {
    labels: ["Neurotoxin", "Filler", "Mira Dry", "RFAL", "RF", "RFMN", "Laser Treatment","Coolsculpting","Contoura","Thread Lifts","Vi Peel","Sculptra Butt","Sculptra Face ","Asthetic Services","Tattoo"],
    datasets: [
      {
        label: "Revenu",
        data: [30, 15, 62, 65, 61, 65, 40, 50, 53, 68, 45, 50,30,45,50 ],
