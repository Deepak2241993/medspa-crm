...
<!-- <div class="modal-dialog modal-lg" id="walletServices" tabindex="-1" role="dialog" aria-labelledby="walletServicesLabel" aria-hidden="true"> -->
  <div class="modal-dialog" role="document">
	 <div class="modal-content" style="    width: 1200px; margin-left: -300px;">
		<div class="modal-header">
		  <h5 class="modal-title" id="walletServicesLabel">Available Service in Wallet</h5>
