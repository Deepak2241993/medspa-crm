                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="m-l-15">
                                            <h2 class="m-b-0">$<?=$today_total_pay?></h2>
                                            <p class="m-b-0 text-muted">Today Pay</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="m-l-15">
                                            <h2 class="m-b-0">$<?=$week_total_pay?></h2>
                                            <p class="m-b-0 text-muted">Weekly Pay</p>
                                        </div>
                                    </div> 
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="m-l-15">
                                            <h2 class="m-b-0">$<?=$month_total_pay?></h2>
                                            <p class="m-b-0 text-muted">Mothly pay</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="m-l-15">
                                            <h2 class="m-b-0"><?=$year_total_pay?></h2>
                                            <p class="m-b-0 text-muted">Yearly Pay</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
