                                    ...
                                    <?=form_open('AdminLogin/checklogin')?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-affix">
                                                ...
                                                <select class="form-control" name="usertype" id="userName">
                                                    <option value="">Select User Type</option>
                                                    <option value="super admin">Deepak</option>
                                                    <option value="admin">Khushi</option>
                                                    <option value="b">Access3</option>
                                                    <option value="c">Access4</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group">
