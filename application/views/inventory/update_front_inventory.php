...
<div class="m-t-25">
<?=form_open('inventory/front_inventory_update/'.$inventory[0]['inventory_id'] , array('enctype' => 'multipart/form-data'))?>
	...
	<div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" class="form-control" name="product_type"value="front"required>
                    </div>
                    <!-- <div class="form-group">
