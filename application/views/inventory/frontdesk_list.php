...
<div class="card-body">
    ...
    <div class="button-link mt-4">
        <a href="<?=base_url().'inventory/create_product_front'?>" class="btn btn-primary">Introduce Product</a>
        <a href="" class="btn btn-success" data-toggle="modal" data-target="#exampleModal">Incomeing Inventory</a>
    </div>
<div class="m-t-25">
...
<table id="data-table" class="table table-bordered">
    ...
    <tbody>
        ...
        ?>
            ...
            <?php if($this->session->userdata('user_type')=='admin'){ ?>
            <td><a href="<?=base_url()?>inventory/update_front_inventory/<?= $data['inventory_id']?>" class="btn btn-primary mb-2 btn-xs">Edit</a>
			
			<a href="<?=base_url()?>inventory/delete_front_inventory/<?= $data['inventory_id']?>" class="btn btn-danger btn-xs">Delete</a>
		<?php } ?>	
        </td>
        </tr>
        <?php
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?= form_open('inventory/save_front_inventory', array('enctype' => 'multipart/form-data')) ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" name="product_type" class="form-control" value="front" required>
                    </div>
                    <!-- <div class="form-group">
