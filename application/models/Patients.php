	...
	public function search_patient()
{
	...
	public function ProviderRegister()
	{
		$this->load->view('header');
		$this->load->view('sidenavbar');
		$this->load->view('ProviderRegister');
		$this->load->view('footer');
	}
...
// 				$this->load->view('footer');
	...
	public function deleteprovider($id){
		$this->PatientModel->deleteprovider($id);
		$this->session->set_flashdata('success','Delete sucessfully');
	   redirect(base_url().'providers');
 	}

	 public function editProviders($id){
	  $result['providers'] = $this->PatientModel->getproviderbyid($id);
	//   print_r($result['providers']); die();
      $this->load->view('header');
      $this->load->view('sidenavbar');
      $this->load->view('patientspages/ProviderUpdate',$result);
      $this->load->view('footer');
    }

	
	public function updateProviders($id){
		...
		$this->PatientModel->updateProvidersdata($update,$id);
		$this->session->set_flashdata('success','Update Provider Sucessfully');
		redirect(base_url().'providers');
...
/************** Get all patients list***************/
	...
	public function allprovider()
	{
		...
		$result['data'] = $this->PatientModel->getallprovider($_POST);
		$result['dates']= $_POST;
		// echo'<pre>';print_r($result);die;
		$this->load->view('header');
		$this->load->view('sidenavbar');
		$this->load->view('patientspages/providerlist',$result);
		$this->load->view('footer');
	}
...
// 			echo'<pre>';print_r($this->input->post());die;
 ...
 //patient data 
   ...
   public function generic($noteid,$pid)
	{
		 $result['pname']=$this->db->select('pname')->from('patient_registration')->where('prid',$pid)->get()->row();
		$result['servicesdata'] = $this->ServiceModel->getprovideServices($noteid,$pid);
       // print_r(array_sum(array_column($result['servicesdata'], 's_amount')));die;
		$result['productsdata'] = $this->ServiceModel->getusedproducts($noteid,$pid);
	//	print_r(array_sum(array_column($result['productsdata'], 'p_amount')));die;
		$result['session_package'] = $this->PatientModel->getall_session_package_id($pid);
		$result['total_amount'] = array_sum(array_column($result['servicesdata'], 's_amount'))+ array_sum(array_column($result['productsdata'], 'p_amount')) + array_sum(array_column($result['session_package'], 'amount'));
		$result['notesid']= $noteid;
		$result['pid']= $pid;
		//echo'<pre>';print_r($result['session_package']);die;
		$this->load->view('header');
		$this->load->view('sidenavbar');
    	$this->load->view('patientspages/generic_service',$result);
    	$this->load->view('footer');
	}
